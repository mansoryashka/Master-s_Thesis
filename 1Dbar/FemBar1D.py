...
if __name__ == '__main__':
    ...
    ax.set_ylabel('Relative error of deformation')
    ax.set_xlabel('$X$')
    ax2.set_ylabel('Relative error of deformation gradient')
    ax2.set_xlabel('$X$')
    ...
    ax3.loglog(norms.keys(), norms.values(), '--o')
